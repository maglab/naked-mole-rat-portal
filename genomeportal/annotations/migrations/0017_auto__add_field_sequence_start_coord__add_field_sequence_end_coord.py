...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sequence.start_coord'
        db.add_column(u'annotations_sequence', 'start_coord',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Sequence.end_coord'
        db.add_column(u'annotations_sequence', 'end_coord',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sequence.start_coord'
        db.delete_column(u'annotations_sequence', 'start_coord')

        # Deleting field 'Sequence.end_coord'
        db.delete_column(u'annotations_sequence', 'end_coord')
    ...
    models = {
        u'annotations.gene': {
            ...
            'in_genage': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
        ...
        u'annotations.sequence': {
            ...
            'end_coord': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'start_coord': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
