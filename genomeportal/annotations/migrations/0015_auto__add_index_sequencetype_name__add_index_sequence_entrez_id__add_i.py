...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SequenceType', fields ['name']
        db.create_index(u'annotations_sequencetype', ['name'])

        # Adding index on 'Sequence', fields ['entrez_id']
        db.create_index(u'annotations_sequence', ['entrez_id'])

        # Adding index on 'Sequence', fields ['has_genes']
        db.create_index(u'annotations_sequence', ['has_genes'])

        # Adding index on 'Sequence', fields ['ncbi_symbol']
        db.create_index(u'annotations_sequence', ['ncbi_symbol'])

        # Adding index on 'Sequence', fields ['ncbi_name']
        db.create_index(u'annotations_sequence', ['ncbi_name'])


    def backwards(self, orm):
        # Removing index on 'Sequence', fields ['ncbi_name']
        db.delete_index(u'annotations_sequence', ['ncbi_name'])

        # Removing index on 'Sequence', fields ['ncbi_symbol']
        db.delete_index(u'annotations_sequence', ['ncbi_symbol'])

        # Removing index on 'Sequence', fields ['has_genes']
        db.delete_index(u'annotations_sequence', ['has_genes'])

        # Removing index on 'Sequence', fields ['entrez_id']
        db.delete_index(u'annotations_sequence', ['entrez_id'])

        # Removing index on 'SequenceType', fields ['name']
        db.delete_index(u'annotations_sequencetype', ['name'])
    ...
    models = {
        ...
        u'annotations.sequence': {
            ...
            'entrez_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_index': 'True'}),
            ...
            'has_genes': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
            'in_genage': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ncbi_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
            'ncbi_predicted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ncbi_symbol': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'db_index': 'True'}),
