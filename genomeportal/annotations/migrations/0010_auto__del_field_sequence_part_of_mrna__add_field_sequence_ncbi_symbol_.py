...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sequence.part_of_mrna'
        db.delete_column(u'annotations_sequence', 'part_of_mrna')

        # Adding field 'Sequence.ncbi_symbol'
        db.add_column(u'annotations_sequence', 'ncbi_symbol',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Sequence.ncbi_name'
        db.add_column(u'annotations_sequence', 'ncbi_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Sequence.entrez_id'
        db.add_column(u'annotations_sequence', 'entrez_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Sequence.ncbi_predicted'
        db.add_column(u'annotations_sequence', 'ncbi_predicted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sequence.part_of_mrna'
        db.add_column(u'annotations_sequence', 'part_of_mrna',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Sequence.ncbi_symbol'
        db.delete_column(u'annotations_sequence', 'ncbi_symbol')

        # Deleting field 'Sequence.ncbi_name'
        db.delete_column(u'annotations_sequence', 'ncbi_name')

        # Deleting field 'Sequence.entrez_id'
        db.delete_column(u'annotations_sequence', 'entrez_id')

        # Deleting field 'Sequence.ncbi_predicted'
        db.delete_column(u'annotations_sequence', 'ncbi_predicted')
    ...
    models = {
        ...
        u'annotations.sequence': {
            ...
            'ncbi_symbol': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
