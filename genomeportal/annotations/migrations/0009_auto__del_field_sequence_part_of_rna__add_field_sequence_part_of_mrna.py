...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sequence.part_of_rna'
        db.delete_column(u'annotations_sequence', 'part_of_rna')
    ...
    def backwards(self, orm):
        # Adding field 'Sequence.part_of_rna'
        db.add_column(u'annotations_sequence', 'part_of_rna',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'annotations.sequence': {
            ...
            'part_of_mrna': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
