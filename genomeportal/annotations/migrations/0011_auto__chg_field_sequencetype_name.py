...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SequenceType.name'
        db.alter_column(u'annotations_sequencetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'SequenceType.name'
        db.alter_column(u'annotations_sequencetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
