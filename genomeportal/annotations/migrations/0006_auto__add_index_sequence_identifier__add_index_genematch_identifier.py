...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Sequence', fields ['identifier']
        db.create_index(u'annotations_sequence', ['identifier'])

        # Adding index on 'GeneMatch', fields ['identifier']
        db.create_index(u'annotations_genematch', ['identifier'])


    def backwards(self, orm):
        # Removing index on 'GeneMatch', fields ['identifier']
        db.delete_index(u'annotations_genematch', ['identifier'])

        # Removing index on 'Sequence', fields ['identifier']
        db.delete_index(u'annotations_sequence', ['identifier'])
