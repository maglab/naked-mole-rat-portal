...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Gene', fields ['in_genage']
        db.create_index(u'annotations_gene', ['in_genage'])

        # Adding index on 'Sequence', fields ['in_genage']
        db.create_index(u'annotations_sequence', ['in_genage'])


    def backwards(self, orm):
        # Removing index on 'Sequence', fields ['in_genage']
        db.delete_index(u'annotations_sequence', ['in_genage'])

        # Removing index on 'Gene', fields ['in_genage']
        db.delete_index(u'annotations_gene', ['in_genage'])
