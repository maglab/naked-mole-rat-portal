...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sequence.in_genage'
        db.add_column(u'annotations_sequence', 'in_genage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sequence.in_genage'
        db.delete_column(u'annotations_sequence', 'in_genage')
    ...
    models = {
        ...
        u'annotations.sequence': {
            ...
            'ncbi_symbol': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
