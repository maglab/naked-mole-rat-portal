...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sequence.part_of'
        db.add_column(u'annotations_sequence', 'part_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='related_sequences', null=True, to=orm['annotations.Sequence']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sequence.part_of'
        db.delete_column(u'annotations_sequence', 'part_of_id')
